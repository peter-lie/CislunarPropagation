...
# plt.plot(SSdataplot4.keys(), SSdataplot4.values(), color=[0.4940, 0.1840, 0.5560], label='${\\frac{A}{m} = .5 \: \\frac{m^2}{kg}}$', alpha = 0.9)
...
plt.xticks([0, len(IBdataplot1)/6, len(IBdataplot1)/3, len(IBdataplot1)/2, 2*len(IBdataplot1)/3, 5*len(IBdataplot1)/6, len(IBdataplot1)], ['0', '${\\frac{\pi}{3}}$', '${\\frac{2\pi}{3}}$', '${\pi}$', '${\\frac{4\pi}{3}}$', '${\\frac{5\pi}{3}}$', '2${\pi}$'])
